...
export class JsonMemoryStore {
  ...
  async replaceAll(memories) {
    ...
    this.writeQueue = writePromise.catch((error) => {
      ...
      // Return undefined to prevent permanently rejecting the queue
    });
    await writePromise;
  }
  ...
  async add(memory) {
    ...
    this.writeQueue = writePromise.catch((error) => {
      console.error('Write queue error during add:', error);
    });
    await writePromise;
  }
  ...
  async update(memory) {
    ...
    this.writeQueue = writePromise.catch((error) => {
      console.error('Write queue error during update:', error);
    });
    await writePromise;
  }
  ...
  async delete(id) {
    ...
    this.writeQueue = writePromise.catch((error) => {
      console.error('Write queue error during delete:', error);
    });
    await writePromise;
  }
